  ...
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        <div class="welcome ue-clear"><span>欢迎您,</span><a href="javascript:;" class="user-name"><?php echo ($user_name); ?></a></div>
      ...
      <div class="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="gongwen">
            ...
            <ul class="subnav">
              <li><a href="javascript:;" date-src="<?php echo U('Doc/index');?>">公文列表</a></li>
...
<div class="exitDialog">
  <div class="dialog-content">
    ...
    <div class="ui-dialog-text">
      ...
      <div class="buttons">
        <a href="<?php echo U('Main/logout');?>"><input type="button" class="button long2 ok" value="确定" /></a>
