...
<form action="" method="post" enctype='multipart/form-data'>
    <div class="main">
        <p class="short-input ue-clear">
            <label>标题：</label>
            <input name="doc_name" value="<?php echo ($data["doc_name"]); ?>" type="text" placeholder="公文标题" />
        </p>
        <p class="short-input ue-clear">
            <label>图片：</label>
            <input type="file" name="doc_file" />
            <img src="<?php echo ($data["doc_file"]); ?>" alt="">
        </p>
        <p class="short-input ue-clear" style="float:left;">
            <label>内容：</label>
        </p>
        <p style='width:900px; padding-left:0; float:left;'>
            <textarea name="doc_content" id="editor" style="width:800px;height:400px">value="<?php echo ($data["doc_content"]); ?>"</textarea>
        </p>
